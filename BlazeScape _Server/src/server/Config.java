...
public class Config {
	...
	public static final String SERVER_NAME = "BlazeScape";
	...
	public static final int START_LOCATION_X = 2439; // start here
	public static final int START_LOCATION_Y = 3088;
	public static final int RESPAWN_X = 2439; // when dead respawn here
	public static final int RESPAWN_Y = 3088;
	...
	public static final int MELEE_EXP_RATE = 10; // damage * exp rate
