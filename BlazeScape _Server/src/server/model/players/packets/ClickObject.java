    ...
    public void processPacket(Client client, int i, int j)
    {
        ...
        case 132: 
            ...
            if(client.playerRights >= 2) {
				client.sendMessage("Object ID:" + client.objectId + " - X: " + client.objectX + " - Y: " + client.objectY);
			}
            ...
            } else
            {
				...
				case 4408:
					...
					if(client.goodDistance(client.objectX, client.objectY, client.getX(), client.getY(), client.objectDistance)) {
						client.getPA().movePlayer(3429, 3538, client.heightLevel);
					}
					break;
				...
				case 6282:
					client.objectDistance = 2;
					if(client.goodDistance(client.objectX, client.objectY, client.getX(), client.getY(), client.objectDistance)) {
						client.getPA().movePlayer(Config.RESPAWN_X, Config.RESPAWN_Y, 0);
					}
					break;
