...
public class DialogueHandler {
	...
	public void sendWelcomeScreen(String text, String text1, String text2, String text3, String text4, String text5, String text6, String text7, String text8, String text9, String text10, String title) {
		c.getPA().sendFrame126(title, 15950);
		c.getPA().sendFrame126(text, 15959);
		c.getPA().sendFrame126(text1, 15960);
		c.getPA().sendFrame126(text2, 15961);
		c.getPA().sendFrame126(text3, 15951);
		c.getPA().sendFrame126(text4, 15952);
		c.getPA().sendFrame126(text5, 15953);
		c.getPA().sendFrame126(text6, 15954);
		c.getPA().sendFrame126(text7, 15955);
		c.getPA().sendFrame126(text8, 15956);
		c.getPA().sendFrame126(text9, 15957);
		c.getPA().sendFrame126(text10, 15958);
		c.getPA().showInterface(15944);
	}
